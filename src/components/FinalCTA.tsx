...
const FinalCTA = () => {
  ...
  return (
    <div
      id="contact"
      ref={sectionRef}
      className="py-24 bg-cta-gradient relative overflow-hidden"
    >
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="blue-glass-card rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-vincero-lightBlue mb-1">
                24/7
              </div>
            ...
            <div className="blue-glass-card rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-vincero-orange mb-1">
                15 días
              </div>
